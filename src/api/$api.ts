      ...
      v1: {
        ...
        tags: {
          ...
          get: (option?: { query?: Methods_1jspgi['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_1jspgi['get']['resBody'], BasicHeaders, Methods_1jspgi['get']['status']>(prefix, PATH5, GET, option).json(),
          /**
           * @returns Successful Response
           */
          $get: (option?: { query?: Methods_1jspgi['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_1jspgi['get']['resBody'], BasicHeaders, Methods_1jspgi['get']['status']>(prefix, PATH5, GET, option).json().then(r => r.body),
          /**
           * @returns Successful Response
           */
          post: (option: { body: Methods_1jspgi['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1jspgi['post']['resBody'], BasicHeaders, Methods_1jspgi['post']['status']>(prefix, PATH5, POST, option).json(),
          /**
           * @returns Successful Response
           */
          $post: (option: { body: Methods_1jspgi['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1jspgi['post']['resBody'], BasicHeaders, Methods_1jspgi['post']['status']>(prefix, PATH5, POST, option).json().then(r => r.body),
        ...
        users: {
          _user_id: (val3: string) => {
            ...
            return {
              favorite: {
                 ...
                 */
                get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_187vila['get']['resBody'], BasicHeaders, Methods_187vila['get']['status']>(prefix, `${prefix3}${PATH7}`, GET, option).json(),
                /**
                 * @returns Successful Response
                 */
                $get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_187vila['get']['resBody'], BasicHeaders, Methods_187vila['get']['status']>(prefix, `${prefix3}${PATH7}`, GET, option).json().then(r => r.body),
              ...
              works: {
                ...
                get: (option?: { query?: Methods_1h771y4['get']['query'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods_1h771y4['get']['resBody'], BasicHeaders, Methods_1h771y4['get']['status']>(prefix, `${prefix3}${PATH8}`, GET, option).json(),
                /**
                 * @returns Successful Response
                 */
                $get: (option?: { query?: Methods_1h771y4['get']['query'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods_1h771y4['get']['resBody'], BasicHeaders, Methods_1h771y4['get']['status']>(prefix, `${prefix3}${PATH8}`, GET, option).json().then(r => r.body),
          ...
          get: (option?: { query?: Methods_r5qu0t['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_r5qu0t['get']['resBody'], BasicHeaders, Methods_r5qu0t['get']['status']>(prefix, PATH6, GET, option).json(),
          /**
           * @returns Successful Response
           */
          $get: (option?: { query?: Methods_r5qu0t['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_r5qu0t['get']['resBody'], BasicHeaders, Methods_r5qu0t['get']['status']>(prefix, PATH6, GET, option).json().then(r => r.body),
        ...
        works: {
            ...
            return {
              comments: {
                ...
                get: (option?: { query?: Methods_1np2jo8['get']['query'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods_1np2jo8['get']['resBody'], BasicHeaders, Methods_1np2jo8['get']['status']>(prefix, `${prefix3}${PATH10}`, GET, option).json(),
                /**
                 * @returns Successful Response
                 */
                $get: (option?: { query?: Methods_1np2jo8['get']['query'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods_1np2jo8['get']['resBody'], BasicHeaders, Methods_1np2jo8['get']['status']>(prefix, `${prefix3}${PATH10}`, GET, option).json().then(r => r.body),
                /**
                 * @returns Successful Response
                 */
                post: (option: { body: Methods_1np2jo8['post']['reqBody'], query?: Methods_1np2jo8['post']['query'] | undefined, config?: T | undefined }) =>
                  fetch<Methods_1np2jo8['post']['resBody'], BasicHeaders, Methods_1np2jo8['post']['status']>(prefix, `${prefix3}${PATH10}`, POST, option).json(),
                /**
                 * @returns Successful Response
                 */
                $post: (option: { body: Methods_1np2jo8['post']['reqBody'], query?: Methods_1np2jo8['post']['query'] | undefined, config?: T | undefined }) =>
                  fetch<Methods_1np2jo8['post']['resBody'], BasicHeaders, Methods_1np2jo8['post']['status']>(prefix, `${prefix3}${PATH10}`, POST, option).json().then(r => r.body),
              ...
              favorite: {
                 ...
                 */
                get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_bhrxp6['get']['resBody'], BasicHeaders, Methods_bhrxp6['get']['status']>(prefix, `${prefix3}${PATH7}`, GET, option).json(),
                /**
                 * @returns Successful Response
                 */
                $get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_bhrxp6['get']['resBody'], BasicHeaders, Methods_bhrxp6['get']['status']>(prefix, `${prefix3}${PATH7}`, GET, option).json().then(r => r.body),
                /**
                 * @returns Successful Response
                 */
                post: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_bhrxp6['post']['resBody'], BasicHeaders, Methods_bhrxp6['post']['status']>(prefix, `${prefix3}${PATH7}`, POST, option).json(),
                /**
                 * @returns Successful Response
                 */
                $post: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_bhrxp6['post']['resBody'], BasicHeaders, Methods_bhrxp6['post']['status']>(prefix, `${prefix3}${PATH7}`, POST, option).json().then(r => r.body),
                /**
                 * @returns Successful Response
                 */
                delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_bhrxp6['delete']['resBody'], BasicHeaders, Methods_bhrxp6['delete']['status']>(prefix, `${prefix3}${PATH7}`, DELETE, option).json(),
                /**
                 * @returns Successful Response
                 */
                $delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<Methods_bhrxp6['delete']['resBody'], BasicHeaders, Methods_bhrxp6['delete']['status']>(prefix, `${prefix3}${PATH7}`, DELETE, option).json().then(r => r.body),
                $path: () => `${prefix}${prefix3}${PATH7}`,
              },
              /**
               * @returns Successful Response
          ...
          get: (option?: { query?: Methods_m1iqh7['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_m1iqh7['get']['resBody'], BasicHeaders, Methods_m1iqh7['get']['status']>(prefix, PATH9, GET, option).json(),
          /**
           * @returns Successful Response
           */
          $get: (option?: { query?: Methods_m1iqh7['get']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_m1iqh7['get']['resBody'], BasicHeaders, Methods_m1iqh7['get']['status']>(prefix, PATH9, GET, option).json().then(r => r.body),
          /**
           * @returns Successful Response
           */
          post: (option: { body: Methods_m1iqh7['post']['reqBody'], query: Methods_m1iqh7['post']['query'], config?: T | undefined }) =>
            fetch<Methods_m1iqh7['post']['resBody'], BasicHeaders, Methods_m1iqh7['post']['status']>(prefix, PATH9, POST, option).json(),
          /**
           * @returns Successful Response
           */
          $post: (option: { body: Methods_m1iqh7['post']['reqBody'], query: Methods_m1iqh7['post']['query'], config?: T | undefined }) =>
            fetch<Methods_m1iqh7['post']['resBody'], BasicHeaders, Methods_m1iqh7['post']['status']>(prefix, PATH9, POST, option).json().then(r => r.body),
